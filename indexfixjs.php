...
if(isset($_POST['submit'])){
  ...
  if (check_email_address($email)) {
    ...
    mail("1017allen@gmail.com", "Portfolio | Website Contact Request", $send_to_me, "From:" . $email);
...
<body>
  <div id="wrapper">
    <div id="mast-head">
      <div id="header">
        <h1><a href="/">Angelina Allen's Portfolio</a></h1>
      </div>
    </div>
      ...
      <div id="slideshow">
        ...
        <div id="slides">
          ...
          <form method="post" action="<?=curPageURL();?>">
            <label for="name">Name</label><input type="text" name="name" id="name" value="<?= @$name;?>Name" class="clearit" />
            <label for="email">Email</label><input type="text" name="email" id="email" value="<?= @$email;?>Email" class="clearit" />
            <label for="message">Message</label><textarea name="message" id="message" class="clearit"><?= @$message;?>Message</textarea>
...
<div id="mast-content">
    ...
    <div class="project">
      ...
      <div class="project_images">
        <ul class="col1">
          ...
          <li id="scrollable">
            <a class="prev"><img src="images/firstfeature/back.png" /></a>
            ...
            <a class="next"><img src="images/firstfeature/next.png" /></a>
          </li>
        </ul>
        <ul class="col2">
  ...
  <div id="footer">
    <p class='copy'>Copyright &copy; 2011 &mdash; Angelina Allen</p>
  </div>
</div>
</body>
</html>
